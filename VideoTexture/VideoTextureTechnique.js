define([
  ...
  "videotexture/VideoTexture.glsl",
  ...
  var Viewshed3DTechnique = (function (d) {
    ...
    c.bindPass = function (a) {
      if (0 === this.configuration.pass || 2 === this.configuration.pass) {
        ...
        this.program.setUniformMatrix4fv("inverseView", a.inverseView);
        ...
        this.program.bindTexture(a.videoMap.glTexture, "videoMap");
        ...
        // this.program.setUniform4fv("groundCenter", a.groundCenter);
        // this.program.setUniform4fv("groundCenter2", a.groundCenter2);
        ...
        this.program.setUniformMatrix4fv(
          "inverseView",
          a.shadowAccumulator._accumulationParams.inverseView
        );
        this.program.setUniform4fv(
          "projInfo",
  ...
  Viewshed3DTechnique.shader =
    new ReloadableShaderModule.ReloadableShaderModule(
      ShadowCastGlsl.ShadowCastShader,
      () =>
        new Promise(function (d, b) {
          require(["./VideoTexture.glsl"], d, b);
        })
    );
